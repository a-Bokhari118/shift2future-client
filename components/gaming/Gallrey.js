const Gallrey = () => {
  return (
    <section className="px-4 relative z-20  w-full bg-[#F4F4F4]">
      ...
      <div class="container mx-auto">
        <div class="grid-cols-3 p-0 lg:p-20 space-y-2 bg-[#F4F4F4] lg:space-y-0 lg:grid lg:gap-3 lg:grid-rows-3">
